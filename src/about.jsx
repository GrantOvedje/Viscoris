        ...
        <>
            ...
            <main>
                <section className="px-6 py-8 sm:px-16 md:px-40 sm:py-16 lg:px-60">
                    ...
                    <p className="pb-1 md:text-xl"> With our <Link className="text-sky-400" to="/products/coffee">Coffee</Link> products you can trust to have a more balanced living, free from stress, for they are more than just a coffe.</p>
